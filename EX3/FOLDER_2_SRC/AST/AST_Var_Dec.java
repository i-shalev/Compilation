...
//        if (newExp != null) AST_Graphviz.getInstance().logEdge(SerialNumber, newExp.SerialNumber);
    ...
    public Type SemantMe() throws Exception {
        ...
        if (exp != null) {
            ...
            if (!(expType instanceof Type_Object))
                throw new SemanticException("Can't assign a non-object");
            ...
            if (varType instanceof Type_Class && !(expType instanceof Type_Class))
                throw new SemanticException("Can't assign non-class to class");

            if (varType instanceof Type_Class && !((Type_Class)expType).isInheritsFrom(varType.name))
